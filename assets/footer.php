                ...
                <div class="row">
                    <div class="col-lg-10 col-md-12">
                        <form action="#" method="post">
                            <input type="email" class="form-control email" name="t1" onsubmit="return start1()" id="email" placeholder="Your email address" required>
            ...
            <div class="row d-flex">
                ...
                <div class="col-lg-8 col-md-12 pt-4">
                    <div class="row pt-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <ul>
                                <li>
                                    <a href="hr-a">HR-A (AUTO)</a>
                                </li>
                                <li>
                                    <a href="hr-b">HR-B (MANUAL/SYNCHRO)</a>
                                </li>
                                <li>
                                    <a href="hr-o">HR (OPEN/ROAD RANGER)</a>
                                </li>
                                <li>
                                    <a href="hc">HC</a>
                                </li>
                        ...
                        <div class="col-md-4">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="student-information">FAQs</a>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="col-lg-4 col-md-12 pt-4 pt-lg-0">
                    ...
                    <div class="busi-inq">
                        ...
                        <a class="nav-link d-flex nv-im" href="https://web.whatsapp.com/send?phone=0498606606&amp;text=Hi, I would like to get more information..">
                            <i class="fa fa-whatsapp" aria-hidden="true"></i>
                            <p class=" d-grid m-0 p-con"><span>Whatsapp</span><span> 0498 606 606</span></p>
                        </a>
                        <div class="soc-icns d-flex">
                            <a href="https://www.facebook.com/Red-Sand-United-Pty-Ltd-106687025560910" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                            <a href="https://www.instagram.com/redsandunitedptyltd/" target="_blank"><i class="fa fa-instagram" aria-hidden="true"></i></a>
                            <a href="https://www.linkedin.com/uas/login?session_redirect=https%3A%2F%2Fwww.linkedin.com%2Fcompany%2Fred-sand-united-pty-ltd%2Fabout%2F%3FviewAsMember%3Dtrue" target="_blank"><i class="fa fa-linkedin" aria-hidden="true"></i></a>
                            <a href="https://in.pinterest.com/redsandunitedptyltd/" target="_blank"><i class="fa fa-pinterest-p" aria-hidden="true"></i></a>
                        </div>
                    </div>
        ...
        <div class="container foot-bar padding-30">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h3>Copyright © 2022 <a href="https://www.trycyfer.com/" target="_blank">Trycyfer</a> Software
                        Development
                        Company </h3>
                </div>
